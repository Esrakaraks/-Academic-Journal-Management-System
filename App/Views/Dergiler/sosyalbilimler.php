...
<html lang="en" dir="ltr">
    ...
    <body>
       ...
       <button type="input" class="btn btn-right" href="<?= URL_ROOT ?>/giris/index">GİRİŞ</button>
        ...
        <center>
       <strong> <h3>FIRAT ÜNİVERSİTESİ SOSYAL BİLİMLER DERGİSİ</h3></strong>
        </center><br>
        <div class="container">
        <img src="/AkademikDer/uploads/images/sosyal.png"   class="rounded" alt="Cinque Terre" width="200" height="259">
       </div>
    </body>
</html>
